...
function FileInfo({file}) {
  ...
  return file&&(
    <div className='text-center border
     flex justify-center m-4 flex-col items-center p-2 rounded-lg shadow-md'>
        ...
        <h1 className='underline font-semibold mt-3'><span className='text-slate-500'>Xfer</span>Link:</h1>
        </div>
        <div className='mt-5'>
            <h2>{file.fileName}</h2>
